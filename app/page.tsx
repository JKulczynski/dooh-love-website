    ...
    <main className="bg-darkBg text-white overflow-x-hidden pb-12">
      ...
      <section className="py-20 px-6 bg-black border-t border-white/5" id="rozmowa">
        <div className="max-w-3xl mx-auto text-center">
          <RevealOnScroll>
            <p className="text-xs uppercase tracking-[0.3em] text-brandCyan mb-4">Wolisz pogadać?</p>
            ...
            <p className="text-muted400 text-sm max-w-xl mx-auto mb-10">
              Powiedz nam o swoim evencie lub produkcie. Wyjdziesz z gotowym planem tras, budżetem i terminami.
            </p>
          </RevealOnScroll>
          <RevealOnScroll delay={100}>
            <div className="border border-white/10 bg-white/5 p-10 md:p-16 flex flex-col items-center gap-6">
              <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
                <a
                  href="https://wa.me/48668046599?text=Chc%C4%99%20om%C3%B3wi%C4%87%20kampani%C4%99%20DOOH-LOVE"
                  target="_blank"
              ...
              <p className="text-[10px] uppercase tracking-widest text-muted600">
          ...
          <div className="grid grid-cols-2 gap-12">
            ...
            <div className="space-y-4">
              ...
              <ul className="text-sm space-y-3 text-muted400">
                ...
                <li>
                  <a href="tel:+48668046599" className="hover:text-brandCyan transition-colors">
                    +48 668 046 599
                  </a>
                </li>
                <li>
                  <a
                    href="https://wa.me/48668046599"
                    target="_blank"
                    rel="noopener noreferrer"
