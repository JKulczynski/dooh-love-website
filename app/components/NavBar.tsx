        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          >
            ...
            <span
              ...
              style={{
                backgroundImage: "repeating-linear-gradient(0deg, transparent 0px, transparent 2px, rgba(0,0,0,0.18) 2px, rgba(0,0,0,0.18) 3px)",
                zIndex: 5,
              }}
            />
          </a>
          <a
            ...
            style={{
              color: "#25D366",
              filter: "drop-shadow(0 0 4px rgba(37,211,102,0.85)) drop-shadow(0 0 12px rgba(37,211,102,0.5))",
            }}
          >
